...
AGENT_REGISTRY: Dict[str, AgentSpec] = {
    ...
    "agent3": AgentSpec(
        name="agent3",
        script_path=REPO_ROOT / "03-Script-Writer" / "n8n" / "ai-health-os-agent3-script-writer-v1.0.json",
        default_input_path=OUTPUTS_DIR / "agent2_compliance_results.json",
        default_output_path=OUTPUTS_DIR / "agent3_script_results.json",
        default_report_path=REPORTS_DIR / "agent3_script_report.md",
        description="短视频脚本生成 Agent（V1.0）：接收 Agent 2 已审核通过的选题，生成 TikTok / Reels / Shorts 英文视频脚本，并输出 JSON 和 Markdown Script Report。",
        enabled_for_cli=False,
    ),
