...
WORKFLOW_PATH = Path(__file__).resolve().parents[1] / "n8n" / "ai-health-os-agent3-script-writer-v1.0.json"
...
class Agent3N8nWorkflowTest(unittest.TestCase):
    ...
    def test_workflow_name_and_node_count(self):
        """工作流名称和节点数量必须符合 Agent 3 V1.0。"""
        self.assertEqual("AI Health OS - Agent 3 Script Writer V1.0", self.workflow["name"])
