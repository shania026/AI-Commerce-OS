...
- [Agent 3 Script Writer v0.1 DEV](../03-Script-Writer/README.md): independent n8n workflow that turns Agent 2 approved topics into English TikTok/Reels/Shorts scripts with QA and JSON/Markdown script reports.
